...
-- ─── SEED DATA ───────────────────────────────────────────────
INSERT IGNORE INTO users (id, name, email, password_hash, avatar_emoji, role)
VALUES
  (1, 'Arjun Mehta',    'arjun@example.com',  '$2b$10$placeholder_hash_1', '🏃', 'organizer'),
  (2, 'Priya Nair',     'priya@example.com',  '$2b$10$placeholder_hash_2', '🎵', 'organizer'),
  (3, 'Kiran Desai',    'kiran@example.com',  '$2b$10$placeholder_hash_3', '📚', 'organizer'),
  (4, 'Samira Rao',     'samira@example.com', '$2b$10$placeholder_hash_4', '🌿', 'organizer'),
  (5, 'Dev Sharma',     'dev@example.com',    '$2b$10$placeholder_hash_5', '⚡', 'user');
